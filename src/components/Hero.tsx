      ...
      <motion.div style={{ opacity }} className="relative z-20 text-center px-6 max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <img
            ...
            decoding="async"
            loading="eager"
            className="block w-full max-w-[250px] md:max-w-[320px] lg:max-w-[380px] h-auto object-contain select-none"
          />

          {/* Slogan */}
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 leading-tight text-center">
            {BRAND.slogan}
          </p>

          {/* Botões */}
<div className="flex flex-col sm:flex-row gap-4 mt-6 group">
  <motion.a
    href={BRAND.whatsapp}
    target="_blank"
