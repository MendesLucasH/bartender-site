      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block w-full sm:w-auto px-6 sm:px-12 py-4 bg-gradient-to-r from-amber-400 to-orange-500 text-black font-bold rounded-full text-lg hover:shadow-2xl transition-all duration-300"
          >
